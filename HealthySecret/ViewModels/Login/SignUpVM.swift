...
class SignUpVM : ViewModel {
    ...
    func transform(input: Input, disposeBag: DisposeBag ) -> Output {
        ...
        var userModel = UserModel( uuid: uuid , name: name ,  tall: "", age: "", sex: "", calorie: 0, nowWeight: 0, goalWeight: 0, ingredients: [], exercise: [] , diarys: [] , loginMethod: loginMethod , blocked: [] , blocking: [], report: []  )
